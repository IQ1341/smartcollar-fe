                ...
                <div class="col-12 col-sm-6 col-md-4">
                    <div class="stat-card bg-gradient-aktivitas">
                        <div class="card-body p-3 p-md-4">
                            <h6 class="text-uppercase opacity-75 fw-bold ls-1">Aktivitas (accelX)</h6>
                            <div class="d-flex align-items-center mt-2">
                                <span class="value-text" id="val-aktivitas">-</span>
                            </div>
                            <div class="mt-2">
                                <span class="badge bg-light text-dark px-3 py-1 rounded-pill" id="val-gerak">-</span>
                            </div>
                ...
                <div class="col-12">
                    <div class="card border-0 rounded-4 glass-card">
                        <div class="card-header bg-transparent border-bottom-0 pt-4 px-3 px-md-4 pb-0 d-flex flex-wrap gap-1 justify-content-between align-items-center">
                            <h5 class="mb-0 fw-bold form-label">Grafik Aktivitas Real-time (accelX)</h5>
                            <small class="text-muted">1 titik / data baru &middot; ±30 titik terakhir</small>
                        </div>
                        <div class="card-body p-3 p-md-4">
...
<script src="../assets/js/aktivitas.js"></script>
